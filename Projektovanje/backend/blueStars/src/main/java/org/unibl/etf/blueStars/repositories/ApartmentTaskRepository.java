...
import org.unibl.etf.blueStars.models.dto.ApartmentTaskNotificationDTO;
import org.unibl.etf.blueStars.models.entities.ApartmentTask;
import org.unibl.etf.blueStars.models.entities.ApartmentTaskId;
...
public interface ApartmentTaskRepository extends JpaRepository<ApartmentTask, Long> {
    ...
    @Query("""
        SELECT new org.unibl.etf.blueStars.models.dto.ApartmentTaskNotificationDTO(
            task.note, 
        ...
        AND notification.user.role IN (
            org.unibl.etf.blueStars.models.enums.UserRole.MANAGER,
            org.unibl.etf.blueStars.models.enums.UserRole.AGENT
        )
    """)
