...
import jakarta.persistence.LockModeType; import org.springframework.data.domain.*; import org.springframework.data.jpa.repository.*; import org.springframework.stereotype.Repository; import org.unibl.etf.blueStars.models.entities.OperationalTask; import org.unibl.etf.blueStars.models.enums.TaskStatus; import java.util.*;
import org.unibl.etf.blueStars.models.enums.TaskSource;
@Repository public interface OperationalTaskRepository extends JpaRepository<OperationalTask,Long>, JpaSpecificationExecutor<OperationalTask>{
 ...
 @Query("select t from OperationalTask t join t.specialization s join AppUser u on u.userId=:workerId join u.specializations us where t.status=org.unibl.etf.blueStars.models.enums.TaskStatus.NEW and us.specializationId=s.specializationId") Page<OperationalTask> findAvailable(Integer workerId, Pageable pageable);
