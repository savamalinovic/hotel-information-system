...
public interface LeaveRequestRepository extends JpaRepository<LeaveRequest, Long>,
    ...
    @Query("""
            ...
            where request.worker.userId = :workerId
              and request.status in (org.unibl.etf.blueStars.models.enums.LeaveRequestStatus.PENDING,
                                     org.unibl.etf.blueStars.models.enums.LeaveRequestStatus.APPROVED)
    ...
    @Query("""
            select request from LeaveRequest request
            where request.worker.userId = :workerId
              and request.status = org.unibl.etf.blueStars.models.enums.LeaveRequestStatus.APPROVED
