...
class B04GuestCheckInIntegrationTest {
    ...
    void managesMultipleGuestsClaimsAndAtomicCheckIn() {
        ...
        assertThat(checkInService.claimHistory(reservationId)).extracting("action")
                .containsExactly(
                        org.unibl.etf.efikas.models.enums.CheckInClaimAction.TAKEN_OVER,
                        org.unibl.etf.efikas.models.enums.CheckInClaimAction.CLAIMED,
                        org.unibl.etf.efikas.models.enums.CheckInClaimAction.RELEASED,
                        org.unibl.etf.efikas.models.enums.CheckInClaimAction.CLAIMED);
